...
$edit_id = $_GET['id'];
$sql_ed = "select O.*,A.agn_name,A.agn_phone,B.bank_name,B.sort_code,B.dollar_acc,B.naira_acc,T.id as to_id,T.loc_name as to_locname,T.loc_addr as to_locaddr,T.color_code to_colorcode,T.loc_phone as to_locphone,F.id as fr_id,F.loc_name as fr_locname,F.loc_addr as fr_locaddr,F.loc_phone as fr_locphone from ex_order O LEFT JOIN from_location F ON F.id=O.fr_loc LEFT JOIN to_location T ON T.id=O.to_loc LEFT JOIN ex_bank B ON B.id=O.or_bank LEFT JOIN  ex_agent A ON A.id=O.or_agent where O.id=$edit_id";
...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title">Order Booking  </h1>
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-body form">
                                    <div class="form-body">
                                        ...
                                        <input type="hidden" name="idorder" id="idorder" class="form-control red" value="<?= $res_ed[0]->id; ?>" readonly>
                                                    ...
                                                    <select  class="selectpicker" id="sel_agent" name="agn_id" data-live-search="true" title="select Agent">
                                                        ...
                                                        for($i=0;$i<count($row_agent);$i++){
                                                         ?>
                                                            ...
                                                            if (($row_agent[$i]->agn_name) == ($res_ed[0]->or_agent)) {
                                                                echo "selected";
                                                            }
                                                            ?>><?= $row_agent[$i]->agn_name . "-" . $res_ed[0]->agn_mobile; ?></option>
                                                                <?php }
                                                                ?>
                                                    </select>
                                                </div>
                                                        ...
                                                        <tbody><tr>
                                                                <td valign="top" style="min-width: 250px;" class="pdright5 mrg_top10">
                                                                    <span>Agent Name</span><br>
                                                                     <input type="hidden"  name="agnord_no" id="agnord_no" value="<?= $res_ed[0]->or_agnum; ?>" class="form-control" readonly>
                                                                     <input type="text"  name="agnord_name" id="agnord_name" value="<?= $res_ed[0]->or_agent; ?>" class="form-control" readonly>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td valign="top" style="min-width: 250px;" class="pdright5">
                                                                    ...
                                                                    <input type="text" name="agnord_mob" id="agnord_mob" value="<?= $res_ed[0]->agn_mobile ?>" class="form-control" readonly>
                                                                </td>
                                                            </tr>
                                                ...
                                                <select id="sel_cont" name="or_container"  class="selectpicker " data-live-search="true" title="select container">
                                                    ...
                                                    for($i=0;$i<count($row_container);$i++){
                                                       ?>
                                                        ...
                                                        if (($row_container[$i]->container_no) == ($res_ed[0]->cont_no)) {
                                                            echo "selected";
                                                        }
                                        ...
                                        <table>
                                            <tbody><tr>
                                                    <td valign="top" style="min-width: 140px;" class="pdright5">
                                                        ...
                                                        <input type="hidden" value="<?= $res_ed[0]->or_container; ?>" id="or_container" name="or_container">
                                                        <input type="text"  name="cont_no" id="cont_no" value="<?= $res_ed[0]->cont_no; ?>" class="form-control" readonly>
                                                    </td>
                                                    <td valign="top" style="min-width: 140px;">
                                                        <span>Container Size</span><br>
                                                        <input type="text" name="cont_sz" id="cont_sz" value="<?= $res_ed[0]->cont_sz ?>" class="form-control" readonly>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td valign="top" style="min-width: 140px;" class="pdright5">
                                                        <span>Loading Date</span><br>
                                                        <input type="text" name="cont_ld" id="cont_ld" value="<?= $res_ed[0]->cont_ld ?>" class="form-control" readonly>
                                                    </td>
                                                    <td valign="top" style="min-width: 140px;">
                                                        <span>Sailing Date</span><br>
                                                        <input type="text" name="cont_sd" id="cont_sd" value="<?= $res_ed[0]->cont_sd ?>" class="form-control" readonly>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td valign="top" style="min-width: 140px;" class="pdright5">
                                                        <span>Closing Date</span><br>
                                                        <input type="text" name="cont_cd" id="cont_cd" value="<?= $res_ed[0]->cont_cd ?>" class="form-control" readonly>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td valign="top" style="min-width: 140px;" class="pdright5">
                                                        <span>Origin Port</span><br>
                                                        <input type="text" name="cont_op" id="cont_op" value="<?= $res_ed[0]->cont_op ?>" class="form-control" readonly>
                                                    </td>
                                                    <td valign="top" style="min-width: 140px;" >
                                                        <span>Destination Port</span><br>
                                                        <input type="text" name="cont_dp" id="cont_dp" value="<?= $res_ed[0]->cont_dp ?>" class="form-control" readonly>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2" valign="top" style="min-width: 140px;">
                                                        <span>Container Status</span><br>
                                                        <input type="text" name="cont_cs" id="cont_cs" value="<?= $res_ed[0]->cont_cs ?>" class="form-control" readonly>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2" valign="top" style="min-width: 140px;">
                                            ...
                                            <table width="100%">
                                                <tbody><tr>
                                                        <td>
                                                            ...
                                                            <textarea class="form-control" id="fr_addr" name="fr_addr" rows="5" cols="100" id="fr_loc" readonly><?= $res_ed[0]->fr_locaddr; ?></textarea>
                                    ...
                                    <div class="portlet-body form">
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="hidden" name="to_loc" id="loc_name" value="<?= $to_loc; ?>">
                                                    <input type="text" name="loc_name" id="loc_name" value="<?= $res_ed[0]->to_locname?>" readonly>
                                                        ...
                                                        <div id="err_cus">
                                                            <select id="sel_cus" name="or_selcus" class="selectpicker" data-live-search="true">
                                                                ...
                                                                while ($row_cus = mysqli_fetch_array($sql_cus)) {
                                                                    ?>
                                                                    <option value="<?= $row_cus['id'] ?>" <?php
                                                                    if (($row_cus['cust_name']) == ($res_ed['or_customer'])) {
                                                                        echo "selected";
                                                                    }
                                                                    ?>><?= strtoupper($row_cus['cust_name']) ?></option>
                                                                        <?php }
                                                                        ?>
                                                            </select>
                                                        </div>
                                                ...
                                                <table>
                                                    <tbody><tr>
                                                            <td valign="top" style="min-width: 140px;">
                                                                ...
                                                                <input type="hidden" name="cus_no" id="cus_no" value="<?= $res_ed['cus_no'] ?>" class="form-control" readonly>
                                                                <input type="hidden" name="cus_name" id="cus_name" value="<?= $res_ed['or_customer'] ?>" class="form-control" readonly>
                                                                <input type="text" name="cus_email" id="cus_email" value="<?= $res_ed['cus_email']; ?>" class="form-control" readonly>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td valign="top" style="min-width: 140px;">
                                                                ...
                                                                <input type="text" name="cus_mobile" id="cus_mobile" value="<?= $res_ed['cus_mobile']; ?>" class="form-control" readonly>
                                                            </td>
                                                    ...
                                                    <div id="err_bank">
                                                        <select id="sel_bank" class="form-control" name="or_bank">
                                                            ...
                                                            while ($row_bank = mysqli_fetch_array($sql_bank)) {
                                                                ?>
                                                                <option value="<?= $row_bank['id'] ?>" <?php
                                                                if ($row_bank['bank_name'] == $res_ed['bank_name']) {
                                                                    echo "selected";
                                                                }
                                                                ?>><?= strtoupper($row_bank['bank_name']) ?></option>
                                                                    <?php }
                                                                    ?>
                                                        </select>
                                                    </div>
                                                </div>
                                                <input type="hidden" name="bank_name" id="bank_name" value="<?= $res_ed['bank_name']; ?>" class="form-control" readonly>
                                                <table>
                                                    <tbody><tr>
                                                            <td valign="top" style="min-width: 140px;">
                                                                <span>Sort Code</span><br>
                                                                <input type="text" name="sort_code" id="sort_code" value="<?= $res_ed['sort_code']; ?>" class="form-control" readonly>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td valign="top" style="min-width: 140px;">
                                                                ...
                                                                <input type="text" name="naira_ac" id="naira_ac" value="<?= $res_ed['naira_acc']; ?>" class="form-control" readonly>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td valign="top" style="min-width: 140px;">
                                                                ...
                                                                <input type="text" name="dollar_ac" id="dollar_ac" value="<?= $res_ed['dollar_acc']; ?>" class="form-control" readonly>
                                                            </td>
                                    ...
                                    <div class="portlet-body form">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="item_desc" name="item_desc" rows="3"><?= $res_ed['item_desc']; ?></textarea>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="or_qty" name="or_qty" class="form-control" value="<?= $res_ed['or_qty']; ?>" placeholder="Enter Quantity"> </div>
                                                </div>
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-body row">
                                            ...
                                            <div class="form-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="agn_freight" id="ag_fright" class="form-control fright groupOfTexbox" value="<?= $res_ed['agn_freight']; ?>" placeholder="0.00"> </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="comp_freight" id="cm_fright" value="<?= $res_ed['comp_freight']; ?>" class="form-control fright groupOfTexbox" placeholder="0.00"> </div>
                                                </div>
                                            ...
                                            <div class="form-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="agn_clearence" id="ag_clearence" value="<?= $res_ed['agn_clearence']; ?>" class="form-control clearence groupOfTexbox" placeholder="0.00"> </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="comp_clearence" id="cm_clearence" value="<?= $res_ed['comp_clearence']; ?>" class="form-control clearence groupOfTexbox" placeholder="0.00"> </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="tot_sum" id="tot_sum" class="form-control" value="<?= $res_ed['tot_sum']; ?>" placeholder="0.00" readonly> </div>
                                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="line" rows="3" cols="30" id="ord_line" readonly><?= $res_ed['line'] ?></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Remarks</label>
                                        <textarea class="form-control" name="remark" id="remark" rows="3"><?= $res_ed['remark']; ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select  class="form-control" name="status_type" id="chg_status">
                                            ...
                                            if ((trim($res_ed['order_status'])) == "Not Ready for Collection") {
                                                echo "selected";
                                            }
                                            ?>>Not Ready for Collection</option>
                                            <option value="On Transit" <?php
                                            if ($res_ed['order_status'] == "On Transit") {
                                                echo "selected";
                                            }
                                            ?>>On Transit</option>
                                            <option value="Cleared"<?php
                                            if ($res_ed['order_status'] == "Cleared") {
                                                echo "selected";
                                            }
                                            ?>>Cleared</option>
                                            <option value="Not Ready for Collection"<?php
                                            if ($res_ed['order_status'] == "Not Ready for Collection") {
                                                echo "selected";
                                            }
                                            ?>>Not Ready for Collection</option>
                                            <option value="Ready for Collection"<?php
                                            if ($res_ed['order_status'] == "Ready for Collection") {
                                                echo "selected";
                                            }
                                            ?>>Ready for Collection</option>
                                            <option value="Collected"<?php
                                            if ($res_ed['order_status'] == "Collected") {
                                                echo "selected";
                                            }
                                            ?>>Collected</option>
                                            <option value="Commision Paid"<?php
                                            if ($res_ed['order_status'] == "Commision Paid") {
                                                echo "selected";
                                            }
                                            ?>>Commision Paid</option>
                                            <option value="Reminder"<?php
                                            if ($res_ed['order_status'] == "Reminder") {
                                                echo "selected";
                                            }
                                            ?>>Reminder</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="stchange_date" id="stchange_date" class="form-control" value="<?= $res_ed['stchange_date']; ?>" placeholder="Last Status Changed Date" readonly/> 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="dxb_payinfo" name="dxb_payinfo" rows="5"><?= $res_ed['dxb_payinfo']; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="paid_amt" name="paid_amt" class="form-control" value="<?= $res_ed['paid_amt']; ?>" placeholder="Paid Amount"> 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="invoice_no" name="invoice_no" class="form-control" value="<?= $res_ed['invoice_no']; ?>" placeholder="Enter Phone Number"> 
                                    ...
                                    <div class="portlet-body form row"> 
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="del_details" name="del_details" rows="3"><?= $res_ed['del_details']; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="cus_complaint" name="cus_complaint" rows="3"><?= $res_ed['cus_complaint']; ?></textarea>
                                            </div>
                                        </div>
                    ...
                    <div class="portlet-body form row"> 
                        ...
                        <form action="sendsms.php" accept-charset="UTF-8" class=" " method="post" name="form_sms" enctype="multipart/form-data" id="send_sms">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Message</label>
                                    <textarea class="form-control" rows="9" cols="100" name="messages"><?= $qry_toloc['loc_addr'] ?>,&nbsp;phone:<?= $qry_toloc['loc_phone']; ?>,pls pay to&nbsp;<?= $res_ed['bank_name']; ?>
,Dollar_Acct#:&nbsp;<?= $res_ed['dollar_acc']; ?>,&nbsp;Naira_Acct#:&nbsp;<?= $res_ed['naira_acc']; ?>,Clearing Chrg=&nbsp;<?= number_format($res_ed['agn_clearence'], 2); ?>(Naira)-Thx(<?= $res_ed['order_no']; ?>)</textarea>
                                </div>
