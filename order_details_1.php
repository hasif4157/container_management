                                                        ...
                                                        <div id="err_cus">
                                                            <select id="sel_cus" name="or_selcus" class="selectpicker" data-live-search="true">
                                                                ...
                                                                for ($i = 0; $i < count($row_cus); $i++) {
                                                                    ...
                                                                    if (($row_cus[$i]->cust_name) == ($res_ed[0]->or_customer)) {
                                                                        echo "selected";
                                                                    }
                                                ...
                                                <table>
                                                    <tbody><tr>
                                                            <td valign="top" style="min-width: 140px;">
                                                                ...
                                                                <input type="hidden" name="cus_no" id="cus_no" value="<?= $res_ed[0]->cus_no ?>" class="form-control" readonly>
                                                                <input type="hidden" name="cus_name" id="cus_name" value="<?= $res_ed[0]->or_customer ?>" class="form-control" readonly>
                                                                <input type="text" name="cus_email" id="cus_email" value="<?= $res_ed[0]->cus_email; ?>" class="form-control" readonly>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td valign="top" style="min-width: 140px;">
                                                                ...
                                                                <input type="text" name="cus_mobile" id="cus_mobile" value="<?= $res_ed[0]->cus_mobile; ?>" class="form-control" readonly>
                                                            </td>
