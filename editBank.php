                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="bank_name" value="<?=$res_ed[0]->bank_name;?>" class="form-control" placeholder="Enter Name"> </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Address</label>
                                    <textarea class="form-control" name="bank_addr" id="bank_addr" rows="3"><?=$res_ed[0]->bank_addr?></textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="branch_name" id="branch_name" class="form-control" value="<?=$res_ed[0]->branch_name;?>" placeholder="Enter Name"> </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="sort_code" id="sort_code" class="form-control" value="<?=$res_ed[0]->sort_code;?>" placeholder="Sort Code"> </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="dollar_acc" id="dollar_acc" class="form-control" value="<?=$res_ed[0]->dollar_acc;?>" placeholder="Dollar Account Number"> </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="naira_acc" class="form-control" value="<?=$res_ed[0]->naira_acc;?>" placeholder="Naira Account Number"> </div>
                                </div>
                                ...
                                <div class="form-actions">
                                    <button type="submit" id="update_bank" class="btn blue">Update</button>
